            ...
            <li key={brag.id} className={styles.card}>
              ...
              <div className={styles.actions}>
                {isAuthenticated ? (
                  <button
                    className={
                      brag.liked_by_me ? `${styles.like} ${styles.liked}` : styles.like
                    }
                    type="button"
                  ...
                  <span className={styles.likeReadonly}>
                    <span aria-hidden="true">♥</span> {brag.like_count}
                  </span>
                )}
